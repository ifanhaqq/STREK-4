<div class="container mt-5" >
    <div class="row">
        ...
        <h1 class="h1 ms-3 mb-4 text-white">Daftar Tabungan</h1>
        <?php Flasher::flash(); ?>
            <table class="table table-secondary table-striped fw-bold border border-dark">
                <thead class="table-dark text-white">
                    ...
                    <th scope="col" class="border border-end border-dark text-center"><button class="rounded" style="background-color: white;" type="button" data-bs-toggle="modal" data-bs-target="#tabunganModal"><i style="color: black; width: 40px;" class="bi bi-plus-lg"></i></button></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
