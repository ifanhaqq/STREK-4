          ...
          <table class="table table-secondary table-striped border border-dark">
            <thead class="table-dark text-white">
              <tr>
                ...
                <th scope="col" class="border border-end border-dark text-center" style="width: 250px">Jumlah yang ingin
                  diambil</th>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL; ?>/pengajuan/tolak/<?= $data['kelas']; ?>" method="post">
...
<div class="modal fade" id="terimaModal" tabindex="-1" aria-labelledby="judulModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL; ?>/pengajuan/terima/<?= $data['kelas']; ?>" method="post">
