        ...
        <div class="col-8">
            <div class="fw-bolder">
                ...
                <div class="rounded text-white"
                    ...
                    <h1 class="mb-5 text-center">Registrasi Akun</h1>
                ...
                <a href="<?= BASEURL; ?>/registrations/accountlist"><button type="button" class="btn btn-primary mt-4">Lihat Daftar Akun</button></a>
            </div>
        </div>
    </div>